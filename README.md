...
2. Create the `gradle.properties` file in this path [XMLRealEstate/](https://github.com/snehaawate/Real-Estate-App/tree/main/RealEstate/) and add the following lines like this example below:
